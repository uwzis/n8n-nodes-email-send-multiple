...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        displayName: 'Delay Between Emails (in seconds)',
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
  ...
  const delayBetweenEmails = this.getNodeParameter('delayBetweenEmails', 0) as number;
...
`;
      ...
      if (delayBetweenEmails > 0 && itemIndex < items.length - 1) {
